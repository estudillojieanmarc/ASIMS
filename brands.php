...
<!-- CONTENT -->
    ...
    <!-- MAIN BAR -->
        <div class="col-10">
          <div class="container-fluid">               
          <h4 class="pt-5">STOCK BRANDS <i class="fa-solid fa-city"></i></h4>
          <ul class="nav nav-tabs my-4">
            ...
            <div class="row pt-3">
              <div class="col-8 d-flex">
                <button class="btn btn-primary mx-1" type="button" data-bs-toggle="modal" data-bs-target="#addBrand">Add Brand</button>
                <button class="btn btn-danger px-4" type="button" id="deleteAllBrand">Delete All</button>
              </div>
          ...
          <div class="row mt-1">
            <table id="brandTable" class="table bg-light align-middle text-center table-bordered table-striped shadow rounded table-hover">
              ...
              <tbody id="showBrand"><!-- BRAND DATA --></tbody>
            </table>
            <div class="row">
                <div class="col-12">
...
<!-- END MODAL -->
    ...
    <script src="function/brands.js"></script>
    ...
    <script>
        ...
        // });
            ...
            // $(function(){
            //     $('table tr:eq(1)').prepend('<th>#</th>');
            //     var number = 0;
            //     $('table tr:gt(1)').each(function(){
            //         number++
            //         $(this).prepend('<td>'+number+'</td>');
            //     });
            // });
