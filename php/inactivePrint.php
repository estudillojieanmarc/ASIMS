...
<div>
    <div class="col-12">
        <div class="container-fluid">
            <div class="row">
                    <h4 class="pt-5 text-center mb-5">A&S MOTORSHOP INACTIVE EMPLOYEES</h4>
            </div>
            ...
            <div class="row mt-3">
                <div class="col-3 ms-auto">
                    ...
                    <a href="http://localhost/ASIMS/inactive.php" type="button" class="btn btn-dark px-5">Cancel</a>
                </div>
            </div>
        </div>
    </div>
    ...
    <script>
        $(document).ready(function(){
            ...
            function showEmployees(){
                $.ajax({
                    url: "/ASIMS/fetch/fetchInactivePrint.php",
                    method: 'POST',
                    data: {getEmployees: 1},
