    ...
    <div class="row">
      <div class="col-12">
          <div class="container-fluid">
            <h4 class="pt-5 text-center mb-4">A&S MOTORSHOP SALES REPORT</h4>
          <div class="row mt-2 px-2">
            ...
            <div class="row mt-3">
                <div class="col-3 ms-auto">
                    ...
                    <a href="http://localhost/ASIMS/sales.php" type="button" class="btn btn-dark px-5">Cancel</a>
                </div>
            </div>
          </div>
          </div>
...
<!-- CONTENT -->
    ...
    <script>
        $(document).ready(function(){
            ...
            function showSales(){
                $.ajax({
                    url: "/ASIMS/fetch/fetchSalesPrint.php",
                    method: 'POST',
                    data: {getSales: 1},
