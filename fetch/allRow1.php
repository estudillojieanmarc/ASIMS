...
if(isset($_POST["requestAllRows"])){
  ...
  inventory b WHERE a.cat_id = b.item_category AND b.item_stock > 0 ORDER BY b.item_stock ASC";
...
if(isset($_POST["requestRows"])){
  ...
  $qry = "SELECT a.cat_id, a.category, b.id, b.item_name, b.item_barcode, b.item_image, 
  b.item_description, b.item_stock, b.item_brand, b.item_category, b.item_price FROM categoryname a , 
  inventory b WHERE a.cat_id = b.item_category AND b.item_stock > 0 ORDER BY b.item_stock ASC LIMIT $limit";
  $statement=$pdo->prepare($qry);
  $statement->execute();
  $inventory = $statement->fetchAll(PDO::FETCH_OBJ);
  $count = $statement->rowCount();
